...
Goerlitz_maxSerie_korrigiert = Sprung_Korrektur(Goerlitz_maxIntSerie, WechselDatum)
...
```{r}
N_pars      = Parameter_Schaetzung(Goerlitz_maxSerie_korrigiert, 
                                   Dauern = c(5, 10, 15, 30, 60, 120, 360, 720, 1440, 2880, 4320, 10080), 
                                   methGEV = "GEV", 
                                   formTyp = "FIX", 
                                   Gamma = -0.1,
...
```{r}
KI      = Unsicherheit_Schaetzung(Goerlitz_maxSerie_korrigiert,
                                  Tn = c(2, 5, 10, 20, 50, 100),
                                  Dauern = c(5, 10, 15, 30, 60, 120, 360, 720, 1440, 2880, 4320, 10080),
                                  methGEV = "GEV",
                                  formTyp = "FIX",
